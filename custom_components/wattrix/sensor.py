...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback):
    ...
    sensors = [
        ...
        WattrixSensor(coordinator, "Wattrix Target Temperature Sensor", "target_temperature", serial_number, "°C"),
        WattrixSensor(coordinator, "Wattrix Minimal Temperature Sensor", "minimal_temperature", serial_number, "°C"),
        WattrixSensor(coordinator, "Wattrix Temperature Recovery Delta Sensor", "temperature_recovery_delta", serial_number, "°C"),
